/*
  # Convert upsert_payroll_record to SECURITY INVOKER

  ## Summary
  Recreates upsert_payroll_record as SECURITY INVOKER with an explicit
  caller company-ownership check. This eliminates the SECURITY DEFINER
  REST-callable warning while preserving all existing functionality.
*/
