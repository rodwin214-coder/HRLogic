/*
  # Add cola parameter to upsert_payroll_record function

  Drops the old signature (43 params) and recreates with p_cola (44 params, default 0).
  All existing callers continue to work because the new parameter has a default value.
*/

DROP FUNCTION IF EXISTS upsert_payroll_record(
  uuid, uuid, uuid,
...
BEGIN
  ...
  INSERT INTO payroll_records (
    ...
    net_pay, status, notes, employer_contributions_benefit, cola, updated_at
  ) VALUES (
    ...
    p_net_pay, p_status, p_notes, p_employer_contributions_benefit, p_cola, now()
  )
