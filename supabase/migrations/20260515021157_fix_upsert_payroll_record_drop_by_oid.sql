/*
  # Fix upsert_payroll_record ambiguous overload
  Drops both overloaded versions by exact argument signature and recreates
  a single definitive function with p_status and p_employer_contributions_benefit.
*/

-- Drop old version (no employer_contributions_benefit, has p_status)
DROP FUNCTION IF EXISTS public.upsert_payroll_record(
...
-- Drop newer version (has employer_contributions_benefit, missing p_status)
DROP FUNCTION IF EXISTS public.upsert_payroll_record(
  uuid, uuid, uuid, numeric, numeric, numeric, numeric, numeric, numeric, numeric,
  numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric,
  numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric, numeric,
...
CREATE FUNCTION upsert_payroll_record(
  p_company_id                     uuid,
  p_period_id                      uuid,
  p_employee_id                    uuid,
